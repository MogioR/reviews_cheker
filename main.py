...
print('\tFirst')
analysis.report_to_sheet_output(sheets, TABLE_ID, 'Data_output')
print('\tSecond')
analysis.report_to_sheet_output_compare(sheets, TABLE_ID, 'Data_output')
print('Done')
